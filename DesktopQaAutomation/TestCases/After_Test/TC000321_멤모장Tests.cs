...
namespace DesktopQaAutomation.TestCases.After_Test
{
    [Trait("Category", "After_Test")]
    [Trait("TC", "000321")]
    public class TC000321_메모장Tests : IClassFixture<AppFixture>
    {
        private readonly AppFixture _fixture;
        private readonly string _tcId = "TC000321"; // 요청하신 규격으로 매칭
        private readonly string _category = "After_Test";

        // 생성자를 통해 SignalR 연결 상태를 공유받음
        public TC000321_메모장Tests(AppFixture fixture)
        {
            _fixture = fixture;
        }
